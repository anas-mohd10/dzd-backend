...
export class ReportsListComponent implements OnInit {
  ...
  reportItems: Array<any> = [
    {
      title: 'Product',
      description: 'Get the product report',
      type: 'product',
    },
    { title: 'Order', description: 'Get the order report', type: 'order' },
    {
      title: 'Order Detailed',
      description: 'Get the detailed order report',
      type: 'order-detailed',
    },
    {
      title: 'Customer',
      description: 'Get the customer report',
      type: 'customer',
    },
    {
      title: 'Customer Order',
      description: 'Get the customer order report',
      type: 'customer-order',
    },
    {
      title: 'Product Order',
      description: 'Get the product order report',
      type: 'product-order',
    },
    { title: 'Sales', description: 'Get the sales report', type: 'sales' },
    {
      title: 'Low Stock',
      description: 'Get the low stock report',
      type: 'lowstock',
    },
    {
      title: 'Abandoned Order',
      description: 'Get the abandoned order report',
      type: 'abandonedorder',
    },
    {
      title: 'Enquiry',
      description: 'Get the enquiry report',
      type: 'enquiry',
    },
    {
      title: 'No Movement',
      description: 'Get the no movement report',
      type: 'nomovement',
    },
    {
      title: 'Product Wise Order',
      description: 'Get the product wise order report',
      type: 'productwiseorder',
    },
    {
      title: 'All Customers',
      description: 'Get the all customers report',
      type: 'allcustomers',
    },
  ];
  ...
  dateRanges: Array<any> = [
    {
      title: '15 Days',
      description: 'Get the sales report for last 15 days',
      dateRange: '15',
    },
    {
      title: '1 Months',
      description: 'Get the sales report for last 30 days',
      dateRange: '1',
    },
    {
      title: '3 Months',
      description: 'Get the sales report for last 3 months',
      dateRange: '3',
    },
    {
      title: '6 Months',
      description: 'Get the sales report for last 6 months',
      dateRange: '6',
    },
    {
      title: '12 Months',
      description: 'Get the sales report for last 12 months',
      dateRange: '12',
    },
  ];
  ...
  exportReport(type: string) {
    switch (type) {
      case 'product':
        this.exportUrl =
          '/api/v1/w/admin/auth' + reportsEndpoints.productReport;
        break;
      case 'order':
      ...
      case 'order-detailed':
        this.exportUrl =
          '/api/v1/w/admin/auth' + reportsEndpoints.detailedOrderReport;
        break;
      case 'customer':
        this.exportUrl =
          '/api/v1/w/admin/auth' + reportsEndpoints.customerReport;
        break;
      case 'customer-order':
        this.exportUrl =
          '/api/v1/w/admin/auth' + reportsEndpoints.customerOrderReport;
        break;
      case 'product-order':
        this.exportUrl =
          '/api/v1/w/admin/auth' + reportsEndpoints.productOrderReport;
        break;
    }
  }
  ...
  toggleProducts(product: any) {
    let index = this.productIds.findIndex(
