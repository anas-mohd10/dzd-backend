...
export class CategoryService {
  ...
  getActiveCategory() {
    const url = this.commonService.getFullUrl(
      this.categoryEndpoints.get_active_categories
    );
    return this.http.get(`${url}`);
  }
  ...
  searchCategory(query: any) {
    const url = this.commonService.getFullUrl(
      this.categoryEndpoints.search_category
    );
  ...
  getCategoryDetails(slug: any) {
    const url = this.commonService.getFullUrl(
      this.categoryEndpoints.getCategoryDetails + '?slug=' + slug
    );
    return this.http.get(`${url}`);
  }
  ...
  getMainCategories() {
    const url = this.commonService.getFullUrl(
      this.categoryEndpoints.get_main_categories
    );
    return this.http.get(`${url}`);
  }
  ...
  getSubCategoriesDetails(data: any) {
    const url = this.commonService.getFullUrl(
      this.categoryEndpoints.get_subcategories_details
    );
    return this.http.post(`${url}`, data);
  }
  ...
  archivedCategories(data: any, page: any) {
    const url = this.commonService.getFullUrl(
      this.categoryEndpoints.archived_categories + '?page=' + page
    );
    return this.http.post(`${url}`, data);
  }
  ...
  childCategories(data: any) {
    const url = this.commonService.getFullUrl(
      this.categoryEndpoints.childCategories
    );
    return this.http.post(`${url}`, data);
  }
  ...
  bulkFileUpload(data: any) {
    const url = this.commonService.getFullUrl(
      this.categoryEndpoints.category_bulk_file_upload
    );
    return this.http.post(`${url}`, data);
  }
  ...
  bulkMediaUpload(data: any) {
    const url = this.commonService.getFullUrl(
      this.categoryEndpoints.categories_bulk_image_upload
    );
    return this.http.post(`${url}`, data);
  }
  ...
  findCategories(data: any) {
    const url = this.commonService.getFullUrl(
      this.categoryEndpoints.find_categories
    );
    return this.http.post(`${url}`, data);
  }
  ...
  deleteCategory(categoryId: string) {
    const url = this.commonService.getFullUrl(
      this.categoryEndpoints.deleteCategory
    );
  ...
  restoreCategory(categoryId: string) {
    const url = this.commonService.getFullUrl(
      this.categoryEndpoints.restoreCategory
    );
  ...
  getSubCategories(data: any) {
    const url = this.commonService.getFullUrl(
      this.categoryEndpoints.get_sub_categories
    );
    return this.http.post(`${url}`, data);
  }
  ...
  dropdownCategories(
    ...
    const url = this.commonService.getFullUrl(
      this.categoryEndpoints.dropdownCategories +
  ...
  defaultCategories(category: string) {
    const url = this.commonService.getFullUrl(
      this.categoryEndpoints.defaultCategories + `?category=${category}`
    );
    return this.http.get(`${url}`);
  }
}
