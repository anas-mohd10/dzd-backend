export const environment = {
  ...
  isMockEnabled: true,
  apiUrl: 'https://alrd-01-dev.dev.storedada.net/api/v1/w/admin/auth',
  baseUrl: 'https://alrd-01-dev.dev.storedada.net/api/v1/w/',
  appBaserl: 'https://alrd-01-dev.dev.storedada.net/api/v1/a/',
