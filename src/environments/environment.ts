export const environment = {
  ...
  isMockEnabled: true,
  apiUrl: 'https://www.thefreshmarketdubai.com/api/v1/w/admin/auth',
  baseUrl: 'https://www.thefreshmarketdubai.com/api/v1/w/',
  appBaserl: 'https://www.thefreshmarketdubai.com/api/v1/a/',
  base: '',
  loginUrl: 'api',
  firebaseConfig: {
